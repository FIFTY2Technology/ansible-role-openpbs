...
| `openpbs_allow_running` | true | Allow OpenPBS systemd service to be started and restarted through Ansible run. Might not be desired during version upgrades, set to 'false' in that case. Default: true |
