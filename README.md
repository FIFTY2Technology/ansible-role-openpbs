...
Molecule scenario is tested in Podman with Rockylinux 9 and OpenPBS version 23.06.06, and includes example tasks to configure some of the requirements below.
...
* Supported Linux distribution include Debian 11, Ubuntu 18.04/20.04 and Rockylinux 8/9.
